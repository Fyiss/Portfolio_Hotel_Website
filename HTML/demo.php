          ...
          <div class="blog_box">
            ...
            <div class="blog_room">
              ...
              <p>
                ...
                of text. All the Lorem Ipsum generatorsIf you are
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <form id="request" class="main_form">
            <div class="row">
              ...
              <div class="col-md-12">
                <input class="contactus" placeholder="Email" type="type" name="emaill" />
              </div>
              <div class="col-md-12">
                <input class="contactus" placeholder="Phone Number" type="type" name="phonenumber" />
              </div>
              <div class="col-md-12">
                <textarea class="textarea" placeholder="Message" type="type" name="message">
Message</textarea>
              </div>
              <div class="col-md-12">
        ...
        <div class="col-md-6">
          <div class="map_main">
            <div class="map-responsive">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d408.5146910899763!2d77.55516804047947!3d13.069470186608084!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae22a5cbf643df%3A0x6fd7923e19737bd8!2sAditya%20Delights!5e0!3m2!1sen!2sin!4v1667487323923!5m2!1sen!2sin"
    ...
    <div class="footer">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <h3>News letter</h3>
            <form action="demo.php" class="bottom_form">
              <input class="enter" placeholder="Enter your email" name="email" type="text" <!-- name="Enter your email"
                -->

              <button class="sub_btn" name="submit">subscribe</button>
            </form>
...
$query = "INSERT INTO FSWD VALUE ('$em')";
$query1 = "INSERT INTO FSWD1 VALUE ('$n','$e','$p','$m')";
